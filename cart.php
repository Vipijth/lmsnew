                                    ...
                                    <td style="width:10%;height:40px;">
                                        <center>
                                            <form method="post" action="">
                                                ...
                                                <button name="delete"  onclick="return confirm('Do you want to delete?');" style="height:30px;text-align:center;border:none; width:95%; font-size:10px;color:#fff; background:#EB4C5E">
