        ...
        <div class="col-md-8 col-lg-4" style="background:#eee;height:500px"  >
            ...
            <div class="row justify-content-md-center ">
                ...
                <?php
                        ...
                        $order=date("Y"). str_replace(' ', '', $subid).$uid.date("d");
                        ?>
                    <?php
                    $_SESSION["cartid"] = $subid;
                    $_SESSION["am"] = $amount;
                   ...
                   // $_SESSION["carid"] = $carid;
                    ...
                    <div class="col-md-9" style="height:auto;background:white;border-radius:20px;padding-right:16px;  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);"  >
                        <form method="POST" name="customerData" action="pay2.php">
                            ...
                            <font style="color:#000; font-size:25px;font-family:Segoe UI semibold">
                                ...
                                <input type="hidden" name="redirect_url" value="http://localhost/newchrys/Response.php"/>

                                <input type="hidden" name="cancel_url" value="http://localhost/newchrys/Response.php"/>
