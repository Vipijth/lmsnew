               	 ...
               	 <div class="row">
                       ...
                       if ($resut->num_rows > 0) {
                        ...
                        while($row = $resut->fetch_assoc()) {
                            $name=$conn-> real_escape_string($row['title']);
                            $cover=$row["cover"]; $ns=$row["title"];
                            $image2=$row["image2"];
                            $image1=$row["image1"];
                            $author=$row["author"];
                            ...
                            ?>
                                 <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                       <input type="text"  name="title" readonly value="<?php echo $ns;?>"   required class="form-control">
         ...
         <div class="form-group row mb-4">
						 	 ...
						 	 <div class="form-group row mb-4">
                                    	 <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Author  Image</label>
                                                 <div class="col-sm-12 col-md-4">
                                                         <div id="image-preview3" class="image-preview" style="background-size:cover;background-repeat:no-repeat;background-image:url('uploads/Blogs/<?php echo $name;?>/images/<?php echo $authorimage;?>'">
                                                                  <label for="image-upload" id="image-label">Choose File</label>
