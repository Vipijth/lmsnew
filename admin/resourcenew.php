                ...
                <form action="create_resource.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div class="form-group">
                                    ...
                                    <textarea  id="about" name="about" maxlength="3000"  style="height:300px;width:100%; resize: none; border-radius:3px;border:1px solid #D8D8D8"></textarea>
                                </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <input type="text" name="titv"  maxlength="40"  class="form-control inputtags" placeholder="Title">
                            </div>

                            <div class="col-sm-4 col-md-2">

                                <input type="text" readonly maxlength="40"  class="form-control inputtags" placeholder="Video">


                            </div>
                            <div class="col-sm-4 col-md-4">

                                <input type="text"  name="link1"      class="form-control inputtags" placeholder="Paste Video Link Here">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <input type="text" name="titv2"  maxlength="40"  class="form-control inputtags" placeholder="Title">
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4">
                                ...
                                <input type="text" name="link2"    class="form-control inputtags" placeholder="Paste Video Link Here">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <input type="text" name="tit"  maxlength="40"  class="form-control inputtags" placeholder="Title">
                            </div>
                            ...
                            <div class="col-sm-4 col-md-3">
                                <div class="custom-file">
                                    <input type="file"  name="files" class="custom-file-input" id="customFile" onchange="return fileTypeValidation()"  >
