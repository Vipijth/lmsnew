...
?>
    ...
    <div class="container-fluid " style="padding-top: 170px;">
        <div class="row justify-content-center"  style="height: auto;padding:1%" >
        <div class="accordion" id="accordionExample" style="width: 100%">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body" style="font-family: segoe ui regular;font-size:14px">
                                    We value your trust. In order to honour that trust,  Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T adheres to ethical standards in gathering, using, and safeguarding any information you provide. Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T (operating under the brand name CHRYSAELLECT™), is a leading edtech company, incorporated in India, for imparting learning. This privacy policy governs your use of the www.chrysaellect.com ('Website') and the other associated applications, products, websites and services managed by the Company. Please read this privacy policy ('Policy') carefully before using the Application, Website, our services and products, along with the Terms of Use ('ToU') provided on the Application and the Website. Your use of the Website, Application, or services in connection with the Application, Website or products ('Services'), or registrations with us through any modes or usage of any products including through SD cards, tablets or other storage/transmitting device shall signify your acceptance of this Policy and your agreement to be legally bound by the same. If you do not agree with the terms of
                                    this Policy, do not use the Website, Application our products or avail any of our Services.</div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed"  style="text-align: left"  type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <div class="card">
                            <div class="card-header" id="heading2">
                                <h2 class="mb-0">
                                    <button  style="text-align: left !important;"  class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                        ...
                        <div class="card">
                            <div class="card-header" id="heading5">
                                <h2 class="mb-0">
                                    <button  style="text-align: left !important;"   class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse2">
                        ...
                        <div class="card">
                            <div class="card-header" id="heading12">
                                <h2 class="mb-0">
                                    <button  style="text-align: left !important;"   class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse12" aria-expanded="false" aria-controls="collapse12">
                                        Log information
                                    </button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="heading13">
                                <h2 class="mb-0">
                                    <button  style="text-align: left !important;"    class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse13" aria-expanded="false" aria-controls="collapse13">
                                     User Communications
                                    </button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapse7" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                <div class="card-body " style="font-family: segoe ui regular;font-size:14px">
                                    We may alert you by email or phone (through sms/call) to inform you about new service offerings or other information which we feel might be useful for you.         </div>
                        </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card">
                                <div class="card-header" id="heading11">
                                    <h2 class="mb-0">
                                        <button   style="text-align: left !important;"   class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse11" aria-expanded="false" aria-controls="collapse11">
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading14">
                                        <h2 class="mb-0">
                                            <button  style="text-align: left !important;"   class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse16" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body " style="font-family: segoe ui regular;font-size:14px">
                                            ...
                                            Our Grievance Officer shall undertake all reasonable efforts to address your grievances at the earliest possible opportunity. You may contact us at: Grievance Officer: India. Reach out to us on info@chrysaellect.com, in case of any queries. </div>
                                    </div> </div>
...
<br><br>
                                    <ul>
                                        ...
                                        <li>
                                            to protect against imminent harm to the rights, property or safety of the Application/Website/ Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T or its users or the public as required or permitted by law;
                                        </li>
                                        <li>
                            ...
                            <div class="card">
                                ...
                                <div id="collapse18" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <div class="card-body " style="font-family: segoe ui regular;font-size:14px">
                                        ...
                                        These Terms & Conditions (“Terms”) of (a) use of our website Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T (“Website”), our applications (“Application”) or any products or services in connection with the Application/,  Website/products (“Services”)  or (b) any modes of registrations or usage of products, including through SD cards, tablets or other storage/transmitting device  are between Chrysaellect Education Solutions LLP (“Company/We/Us/Our”) and its users (“User/You/Your”).
...
<br>
                                    ...
                                    <li>
                                        The Company's products and / or Services, including the Application and content, are compatible only with certain devices/tablets/instruments/hardware < . The Company shall not be obligated to provide workable products and / or services for any instruments that are not recognized by the Company or those instruments that may be purchased from any third party which are not compatible with the Company's products and Services. The company reserves the right to upgrade the table/ type of compatible devices as required from time to time.
                                            ...
                                            <li>
                                                It is likely that a certain faculty may not complete its obligation for a particular module / course, due to personal reasons or otherwise, in such case the rest of the module /course will be completed by an alternate faculty appointed by the company and no refund whatsoever will be given  to the students.
                                            </li>        <br>

                                            <li>
                                                If you are a student on our platform on Chrysaellect M.E.E.T., we may offer free recruitment / placement to you with the schools who choose to register with us. Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T. is   in no way responsible to validate the schools credentials and not responsible in any way for any offer/ proposal which the school may make. It is your responsibility to do complete due diligence about the school and may accept their offer proposal at your own risk and not hold Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T. responsible for the same in any which way possible
                                            </li>        <br>

                                            <li>
                                               If you are a school registered on our platform on Chrysaellect M.E.E.T, we may offer free recruitment / placement to you with the students who have registered through our platform,  Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T. is   in no way responsible to validate the students credentials and not responsible in any  way for any offer/ proposal which the student may accept /make. It is your responsibility to do complete due diligence about the student and may accept their offer at your own risk and not hold Chrysaellect™ Education Solutions LLP as Chrysaellect M.E.E.T. responsible for the same in any which way possible
                                            </li>        <br>

                                            <li>
                                               Payments once made by the students in  non-refundable and non-transferable to another student or another module/course for any reason.
                                            </li>        <br>

                                            <li>

                                                The company does not charge the student / school for placement. Please inform the company if anyone has asked for a fee for placement from our teacher / schools.
                                            </li>        <br>
                                            <li>
                                                The material will be sent to the registered email id only, chosen at the time of registration. All product(s) shall be delivered directly to the email address / mobile number as specified at the time of registration and You cannot, under any circumstances whatsoever, change the email address / telephone number after the registration is processed
                                            </li>        <br>

                                            <li>

                                               In order to access the Services and to avail the use of the Application/products, You shall be required to register yourself with the Application/Services/products, and maintain an account with the Application/Services/products. You will be required to furnish certain information and details, including Your name, mobile number, e-mail address, residential address, payment information (credit/debit card details) if required, and any other information deemed necessary by the Application. With respect to the provision of information, the following may be noted:-
                                            </li>        <br>
                                              <ul>
                                                  <li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        Notice: All notices served by the Company shall be provided via email to Your account or as a general notification on the Application. Any notice to be provided to the Company should be sent to info@chrysaellect.com.
                                                    </li>        <br>
                                            ...
                                            We make all best endeavors to provide You with a pleasant experience. In the unlikely event that You face any issues, please contact us at info@chrysaellect.com.
